...
set_time_limit(0);
/**
 * vineyards.php is a PHP script which is coded in PHP5.5 and runs on PHP CLI.
 * 
 ...
 * @author     Prabhat <prabhat.singh88@gmail.com>
 * @version    1
  */
class Vineyards{
	/**
	...
	public function exportWineAllotmentList($exportFilename){
	   ...
	   $heading="Total number of wines to be sold are ".$this->totalWineSold." by vineyards";
		fwrite($fh, $heading );
